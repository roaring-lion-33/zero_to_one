...
import SectionSubHeader from '../old/SectionSubHeader';
...
const steps = [
  ...
  {
    week: 'Week 3–4',
    title: 'MVP Build – Core Flows',
    desc: 'We build the backend (Rails + Turbo) and wire up your first user flows.',
  },
  {
    week: 'Week 5',
    title: 'Auth + Admin Tools',
    desc: 'Login, roles, dashboards, and basic permissions for you and your users.',
  },
  {
    week: 'Week 6',
    title: 'Polish + Visual QA',
    desc: 'Refining UI, motion, animations, and adding empty states and loading UX.',
  },
  {
    week: 'Week 7',
    title: 'Internal Review + Feedback',
    desc: 'You explore the MVP and request final changes before go-live.',
  },
  {
    week: 'Week 8',
    title: 'Launch + Handoff',
    desc: 'We ship your MVP and hand over docs, deploy access, and training videos.',
  },
];
...
const BuildTimelineCurved: FC = () => {
  ...
  return (
    <section
      id='timeline'
      ref={ref}
      className='relative bg-white text-[#030b1a] py-24 px-4 sm:px-8 overflow-hidden'
    >
      <div className='w-full sm:w-2/3 mx-auto'>
        <div className='text-center sm:text-right mb-20'>
          <SectionSubHeader
            title='Your Road to Launch'
            subtitle='A transparent 8-week timeline that shows how we bring your idea to life.'
          />
        </div>
