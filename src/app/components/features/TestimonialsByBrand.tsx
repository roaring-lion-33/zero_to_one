...
import ClientLogoMarquee from '../old/ClientLogoMarquee';
...
const testimonials = [
  {
    ...
    quote:
      'They helped us ship our MVP in under 30 days — and we were acquired 14 months later.',
    name: 'Jordan M.',
  ...
  },
  {
    ...
    quote:
      'Their team felt like an extension of ours. The launch was smooth and impactful.',
    name: 'Zach G.',
    role: 'Founder, eGent',
  },
  {
    ...
    quote:
      'Everything was designed to impress and built to scale. Couldn’t ask for better partners.',
    name: 'Frank Camp',
  ...
  return (
    ...
    >
      ...
      <div className='mb-10 w-2/3 mx-auto text-right'>
        <h3 className='mb-2 text-3xl font-semibold tracking-tight text-white sm:text-3xl z-20'>
          ...
          return (
            <motion.div
              ...
              className={clsx(
                ...
                isExpanded ? 'z-10 col-span-3 scale-[1.02]' : 'hover:shadow-md',
