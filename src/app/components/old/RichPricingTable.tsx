...
const plans = {
  kickstart: {
    ...
    highlights: [
      ...
      {
        label: 'UI/UX Design',
        description: 'High-fidelity responsive designs covering core flows.',
      },
      {
        label: 'Rails MVP',
        description: 'Turbo + Tailwind + Postgres stack foundation.',
      },
    ],
  },
  sprint: {
    ...
    highlights: [
      {
        ...
        description: 'All the essentials to manage your MVP.',
      },
      {
        label: 'Stripe Payments',
        description: 'Subscription or one-time billing integrations.',
      },
      {
        label: 'PDF Export & Sharing',
        description: 'Built-in export tools with Grover or Puppeteer.',
      },
      {
        label: 'Fly.io or AWS Hosting',
        description: 'Fully deployed and CI/CD-ready.',
      },
    ],
  },
  launchpack: {
    ...
    highlights: [
      {
        label: 'Advanced PDFs & Templates',
        description: 'Styled, dynamic PDF reports for user data.',
      },
      {
        label: 'Tiered Billing + Admin Controls',
        description: 'Custom Stripe tiers and admin tooling.',
      },
      {
        label: 'Custom Field Builder',
        description: 'Visual form editor for dynamic data.',
      },
      {
        label: 'Stimulus UX Toolkit',
        description: 'Undo, toasts, modals, and more.',
      },
    ],
  },
  studio: {
    ...
    highlights: [
      {
        ...
        description: 'Logo, typography, styling system, and PDF design.',
      },
      {
        label: 'Multi-Tenant SaaS',
        description: 'Teams, roles, and custom environments.',
      },
      {
        label: 'Feature Flags & Collaboration',
        description: 'Advanced toggles, notifications, and staging.',
      },
    ],
  },
};
...
export default function ResponsivePricingLayout() {
  ...
  return (
    <MotionSection
      className='relative w-full px-4 py-24 mx-auto bg-white sm:px-6 sm:w-full'
      id='pricing'
    >
      <div className='mb-12 text-center md:text-left w-2/3 mx-auto'>
        <SectionSubHeader
          title='Productized Pricing Tiers'
          subtitle='Each plan is designed for a specific founder stage.'
        />
      </div>
      ...
      <div
        ref={tabNavRef}
        className='sticky top-4 px-2 py-3 mb-8 w-2/3 mx-auto'
      >
