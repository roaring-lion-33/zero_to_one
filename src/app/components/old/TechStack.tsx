...
const sections = {
  Frontend: [
    {
      name: 'Next.js',
      icon: SiNextdotjs,
      description: 'A React framework for building performant web apps.',
    },
    {
      name: 'React',
      icon: SiReact,
      description: 'A library for building user interfaces using components.',
    },
    {
      name: 'TypeScript',
      icon: SiTypescript,
    ...
    },
    {
      name: 'HTML5',
      icon: SiHtml5,
      description: 'Semantic markup for modern websites.',
    },
    {
      name: 'CSS3',
      icon: SiCss3,
      description: 'Styling for layouts, colors, and effects.',
    },
    {
      name: 'Tailwind CSS',
      icon: SiTailwindcss,
  ...
  Backend: [
    ...
    },
    {
      name: 'Grover PDF',
      icon: FaRegFilePdf,
      description: 'PDF generation from HTML in Ruby via Puppeteer.',
    },
    {
      name: 'Stripe',
      icon: SiStripe,
  ...
  DevOps: [
    {
      name: 'Docker',
      icon: SiDocker,
      description: 'Containerize apps for consistency across environments.',
    },
    {
      name: 'AWS',
      icon: SiAmazonwebservices,
      description: 'Cloud services and infrastructure from Amazon.',
    },
    {
      name: 'GitHub',
      icon: SiGithub,
      description: 'Source control and collaborative development platform.',
    },
  ],
};
...
const TechStack: FC = () => {
  ...
  return (
    ...
    >
      <h4 className='text-lg font-semibold mb-2 text-[var(--accent)] text-center'>
        Built With Trusted Tools
      </h4>
      <p className='text-gray-400 mt-2 text-center mb-8'>
        We use a fully open source stack trusted by thousands of startups and
        scale-ups.
      </p>
                ...
                >
                  <Popover.Root>
                    <Popover.Trigger asChild>
                      <button className='flex items-center gap-2 focus:outline-none'>
                        <div className='relative'>
                          ...
                          <Icon
                            className={clsx(
                              'relative z-10 h-5 w-5 group-hover:scale-110 transition-transform',
                    ...
                    <Popover.Content
                      ...
                      sideOffset={8}
                      className={clsx(
                        'rounded-md bg-white border px-4 py-2 shadow-lg w-64 z-50',
                        view === 'grid' ? 'mt-3' : 'mr-3'
                      )}
                    >
