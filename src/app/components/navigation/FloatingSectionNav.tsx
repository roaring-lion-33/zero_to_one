...
const sections = [
  ...
  { id: 'design', label: 'Design', icon: <Ruler size={14} /> },
  { id: 'build', label: 'Build', icon: <Code2 size={14} /> },
  { id: 'launch', label: 'Launch', icon: <Rocket size={14} /> },
  { id: 'proof', label: 'Feedback', icon: <CheckCircle size={14} /> },
  { id: 'about', label: 'About ZeroToOne', icon: <User size={14} /> },
...
export default function DotNavScrollSpy() {
  ...
  return (
    <Tooltip.Provider delayDuration={100}>
      <div className='fixed right-6 top-1/2 -translate-y-1/2 z-50 hidden md:flex flex-col items-center tracking-wide'>
        {/* Progress line */}
                ...
                >
                  <motion.span
                    ...
                    animate={{
                      ...
                      backgroundColor:
                        activeId === section.id ? '#2563eb' : '#d1d5db',
                    }}
